...
```python
>>> token = BasicERC20.deploy("Test Token", "TST", 18, 1e21, {'from': accounts[0]})

Transaction sent: 0x4a61edfaaa8ba55573603abd35403cf41291eca443c983f85de06e0b119da377
  Gas price: 0.0 gwei   Gas limit: 12000000
  BasicERC20.constructor confirmed - Block: 1   Gas used: 521513 (4.35%)
  BasicERC20 deployed at: 0xd495633B90a237de510B4375c442C0469D3C161C
```
...
```python
>>> token
<BasicERC20 Contract '0xd495633B90a237de510B4375c442C0469D3C161C'>
...
Transaction sent: 0xb94b219148501a269020158320d543946a4e7b9fac294b17164252a13dce9534
  Gas price: 0.0 gwei   Gas limit: 12000000
  BasicERC20.transfer confirmed - Block: 2   Gas used: 51668 (0.43%)
